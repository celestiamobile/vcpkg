...
set(WINDOWS_APP_SDK_VERSION 1.7.250401001)
set(WEBVIEW_VERSION 1.0.3179.45)
...
vcpkg_execute_required_process(COMMAND ${NUGET} install Microsoft.Web.WebView2
...
vcpkg_execute_required_process(COMMAND winmdidl /nologo /outdir:.
        ../../Microsoft.Web.WebView2.${WEBVIEW_VERSION}/lib/Microsoft.Web.WebView2.Core.winmd
    WORKING_DIRECTORY ${SOURCE_PATH}/WindowsAppSDK/Microsoft.WindowsAppSDK.${WINDOWS_APP_SDK_VERSION}/include
)
